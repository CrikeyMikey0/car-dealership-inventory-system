...
describe('vehicleService', () => {
  ...
  it('searchVehicles calls search endpoint with query params', async () => {
    const mockVehicles = [{ id: 'v1', make: 'Tesla', model: 'Model 3', year: 2023, category: 'Electric', price: 42990, quantity: 3 }];
  ...
  it('createVehicle posts new vehicle details', async () => {
    const newVehiclePayload = { make: 'Ford', model: 'F-150', year: 2022, category: 'Truck', price: 38500, quantity: 5 };
  ...
  it('updateVehicle puts updated vehicle fields', async () => {
    ...
    const mockUpdated = { id: 'v2', make: 'Ford', model: 'F-150', year: 2022, category: 'Truck', price: 39000, quantity: 5 };
  ...
  it('purchaseVehicle calls purchase endpoint with quantity payload', async () => {
    const mockPurchased = { id: 'v1', make: 'Tesla', model: 'Model 3', year: 2023, category: 'Electric', price: 42990, quantity: 2 };
  ...
  it('restockVehicle calls restock endpoint with quantity payload', async () => {
    const mockRestocked = { id: 'v1', make: 'Tesla', model: 'Model 3', year: 2023, category: 'Electric', price: 42990, quantity: 10 };
