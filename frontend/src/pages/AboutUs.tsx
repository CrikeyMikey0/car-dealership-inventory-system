 ...
 *
 * Displays information about the dealership, its history, values, and team.
 * Fully static page wrapped in the `MainLayout`.
 */
    ...
    <MainLayout>
      <div className="space-y-16 pb-12">
        ...
        <section className="bg-gradient-to-br from-slate-900 to-indigo-900 rounded-3xl p-12 text-center text-white shadow-2xl space-y-6">
          ...
          <div className="pt-4">
            <Link to="/vehicles">
              <Button variant="primary" size="lg" className="bg-indigo-600 text-white hover:bg-indigo-700 shadow-xl rounded-full px-8 border-none">
                Browse Inventory
              </Button>
            </Link>
          </div>
